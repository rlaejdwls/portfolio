...
namespace kr.co.bcu.propio.util
{
    ...
    public class UserActivityHook
    {
        ...
        /// </remarks>
        public UserActivityHook(Module module, bool InstallMouseHook, bool InstallKeyboardHook)
        {
            Start(module, InstallMouseHook, InstallKeyboardHook);
        }
        ...
        /// <param name="InstallKeyboardHook"><b>true</b> if keyboard events must be monitored</param>
        /// <exception cref="Win32Exception">Any windows problem.</exception>
        public void Start(Module module, bool InstallMouseHook, bool InstallKeyboardHook)
        {
